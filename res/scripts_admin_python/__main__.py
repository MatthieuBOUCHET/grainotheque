...
def traitement_legumes(chemin_csv):
    """Fonction traitant le CSV (sep = ;) entrant et l'implémant sous forme de
    liste Python. (Liste de listes, tableau)
    Args:
    -----
...
def traitement_aromatiques(chemin_csv):
    """Fonction traitant le CSV (sep = ;) entrant et l'implémant sous forme de
    liste Python. (Liste de listes, tableau)
    Args:
    -----
...
if __name__ == "__main__":
    ecriture(
        "Fleurs_Sauvages_Locales_Convertis.csv",
        traitement_fleurs_sauvages_locales("Fleurs_Sauvages_Locales.csv"),
    )

    ecriture(
        "Fleurs_Horticoles_Et_Exotiques_Convertis.csv",
        traitement_fleurs_horticoles_et_exotiques("Fleurs_Horticoles_Et_Exotiques.csv"),
    )

    # ecriture(
    #    "Legumes_Convertis.csv",
    #    traitement_fleurs_horticoles_et_exotiques("Legumes.csv"),
    # )

    ecriture(
        "Aromatiques_Convertis.csv",
        traitement_fleurs_horticoles_et_exotiques("Aromatiques.csv"),
    )
